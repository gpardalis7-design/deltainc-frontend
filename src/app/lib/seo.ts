...
export function staticPageSeo(page: StaticSeoPage): SeoMeta {
  const pages = {
    ...
    salaryCalculator: {
      title: "Υπολογισμός Μισθού | Delta Apps",
      description: "Υπολογίστε μεικτό, καθαρό και πληρωτέο ποσό για υπαλλήλους του Δημοσίου με breakdown κρατήσεων, επιδομάτων και φορολογίας για το 2026.",
      path: "/delta-apps/salary-calculator",
    },
  };
  const p = pages[page];
  return {
